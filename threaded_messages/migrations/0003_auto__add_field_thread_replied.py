...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thread.replied'
        db.add_column('threaded_messages_thread', 'replied', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Thread.replied'
        db.delete_column('threaded_messages_thread', 'replied')

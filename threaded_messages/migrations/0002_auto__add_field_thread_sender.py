...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('threaded_messages_thread', 'creator', self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='created_threads', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Thread.sender'
        db.delete_column('threaded_messages_thread', 'creator_id')
